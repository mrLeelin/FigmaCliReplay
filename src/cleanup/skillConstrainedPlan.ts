...
export function buildCleanupSkillDecisionTask(snapshotValue: CleanupSnapshotV1, providerId: string): string {
  ...
  return [
    ...
    "Follow the figma-hierarchy-cleanup plugin V2 safety boundary: this decision is compiled locally into one exact transaction; it cannot create Component, ComponentSet, Variant, PSD, or visual-property changes.",
