...
namespace MagicWarrior.Editor.FigmaBridge
{
    ...
    {
        [System.Serializable] private class Data { public string commonFontAsset; }
        ...
        public static void SetFont(TMP_FontAsset font)
        {
            ...
            if (!string.IsNullOrEmpty(path)) File.WriteAllText(FilePath, JsonUtility.ToJson(new Data { commonFontAsset = path }, true));
        }
    }
}
