...
只读消费 Relay 分析结果，按命名语义和保序原则生成用户确认用的分组计划。
...
def find_result_payload(analysis: Dict[str, Any]) -> Dict[str, Any]:
    """Return the innermost analyze result from CLI wrapper payloads."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--analysis", type=Path, default=Path(".tmp/figma-hierarchy-cleanup/analysis_result.json"), help="Relay 分析结果 JSON")
