#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Export Figma evidence through the project CLI and WebSocket Relay."""
...
CLI_CLIENT_DIR = PLUGIN_ROOT / "client"
DEFAULT_REQUEST_PATH = Path(".tmp/figma-to-prefab/figma_to_prefab_request.json")
DEFAULT_RESULT_PATH = Path(".tmp/figma-to-prefab/figma_to_prefab_relay_result.json")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Figma To Prefab CLI wrapper")
