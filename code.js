...
// DIAG: 插件启动标记 (150 由 build.py 替换)
figma.notify("Figma MCP Relay 插件已加载 (build 150)", { timeout: 1000 });
console.log("[FigmaMcpRelay] 插件初始化完成, build=150, time=" + Date.now());
